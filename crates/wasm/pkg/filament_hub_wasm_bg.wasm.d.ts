...
export function new_serialized_unsigned_tx(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function new_serialized_tx(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
export function serialize_call(a: number, b: number, c: number): void;
export function serialize_unsigned_transaction(a: number, b: number, c: number): void;
...
export function sys_pipe(a: number): number;
export function sys_exit(a: number): void;
...
export function sys_execute_zkr(a: number, b: number, c: number): void;
export function sys_fork(): number;
