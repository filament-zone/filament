...
use sov_rollup_interface::{
    ...
    stf::{fuzzing::BatchReceiptStrategyArgs, BatchReceipt, StoredEvent, TransactionReceipt},
...
fn test_helper(test_queries: Vec<TestExpect>, slots: Vec<SlotCommit<MockBlock, u32, u32>>) {
    ...
    rt.block_on(async {
        ...
        let server_rpc_module = sov_ledger_apis::rpc::server::rpc_module::<
            ...
            u32,
            u32,
            RuntimeEventResponse<filament_hub_stf::runtime::RuntimeEvent<TestSpec, MockDaSpec>>,
        >(ledger_db)
        .unwrap();
