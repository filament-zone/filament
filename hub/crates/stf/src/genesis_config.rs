...
pub struct GenesisPaths {
    ...
    pub outpost_registry_genesis_path: PathBuf,
}
...
impl GenesisPaths {
    ...
    pub fn from_dir(dir: impl AsRef<Path>) -> Self {
        Self {
            ...
            outpost_registry_genesis_path: dir.as_ref().join("outpost_registry.json"),
        }
    }
}
...
fn create_genesis_config<C: Context, Da: DaSpec>(
    ...
    let outpost_registry_config: OutpostRegistryConfig<C> =
        read_json_file(&genesis_paths.outpost_registry_genesis_path)?;

    Ok(GenesisConfig::new(
        accounts_config,
        bank_config,
        sequencer_registry_config,
        outpost_registry_config,
    ))
}
